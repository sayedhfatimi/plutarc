      ...
      switch (JSONResponse.action) {
        ...
        case 'update': {
          ...
          for (let i = 0; i < JSONResponse.data.length; i++) {
            ...
            const criteria = _.pick(payloadObj, keys); // create an object composed of the picked object properties
        ...
        case 'delete': {
          ...
          // loop over message data
          for (let i = 0; i < JSONResponse.data.length; i++) {
            const criteria = _.pick(JSONResponse.data[i], keys); // create an object composed of the picked object properties
